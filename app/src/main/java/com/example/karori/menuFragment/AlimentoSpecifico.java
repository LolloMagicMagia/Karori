...
public class AlimentoSpecifico {
    ...
    public AlimentoSpecifico(String nome, String id, String calorie, String quantità, String proteine, String tipo, String grassi, String carboidrati, String unit) {
        this.nome = nome;
        this.id = id;
